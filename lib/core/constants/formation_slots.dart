...
const Map<String, List<FormationSlot>> kFormationSlots = {
  ...
  '4-4-1-1': [
    ...
    FormationSlot('LCM', 'MID', 0.38, 0.45),
    FormationSlot('LM', 'MID', 0.14, 0.45),
    FormationSlot('SS', 'FWD', 0.50, 0.30),
    FormationSlot('ST', 'FWD', 0.50, _yFwd),
  ],
  '4-3-1-2': [
    FormationSlot('GK', 'GK', 0.50, _yGk),
    ...
    FormationSlot('LCB', 'DEF', 0.38, _yDef),
    FormationSlot('LB', 'DEF', 0.14, _yDef),
    FormationSlot('RCM', 'MID', 0.70, 0.50),
    FormationSlot('CM', 'MID', 0.50, 0.50),
    FormationSlot('LCM', 'MID', 0.30, 0.50),
    FormationSlot('CAM', 'MID', 0.50, 0.33),
    FormationSlot('SS', 'FWD', 0.62, _yFwd),
    FormationSlot('ST', 'FWD', 0.38, _yFwd),
  ],
  '4-1-2-1-2': [
    FormationSlot('GK', 'GK', 0.50, _yGk),
    FormationSlot('RB', 'DEF', 0.86, _yDef),
    ...
    FormationSlot('RCM', 'MID', 0.68, 0.46),
    FormationSlot('LCM', 'MID', 0.32, 0.46),
    FormationSlot('CAM', 'MID', 0.50, 0.33),
    FormationSlot('SS', 'FWD', 0.62, _yFwd),
    FormationSlot('ST', 'FWD', 0.38, _yFwd),
  ],
  ...
  '3-4-2-1': [
    ...
    FormationSlot('CB', 'DEF', 0.50, _yDef),
    FormationSlot('LCB', 'DEF', 0.30, _yDef),
    FormationSlot('RWB', 'MID', 0.90, 0.50),
    FormationSlot('RCM', 'MID', 0.62, 0.48),
    FormationSlot('LCM', 'MID', 0.38, 0.48),
    FormationSlot('LWB', 'MID', 0.10, 0.50),
    FormationSlot('RAM', 'MID', 0.64, 0.32),
    FormationSlot('LAM', 'MID', 0.36, 0.32),
    FormationSlot('ST', 'FWD', 0.50, _yFwd),
  ],
  '3-4-1-2': [
    FormationSlot('GK', 'GK', 0.50, _yGk),
    ...
    FormationSlot('CB', 'DEF', 0.50, _yDef),
    FormationSlot('LCB', 'DEF', 0.30, _yDef),
    FormationSlot('RWB', 'MID', 0.90, 0.48),
    FormationSlot('RCM', 'MID', 0.62, 0.46),
    FormationSlot('LCM', 'MID', 0.38, 0.46),
    FormationSlot('LWB', 'MID', 0.10, 0.48),
    FormationSlot('CAM', 'MID', 0.50, 0.34),
    FormationSlot('RST', 'FWD', 0.62, _yFwd),
    FormationSlot('LST', 'FWD', 0.38, _yFwd),
  ],
  '3-6-1': [
