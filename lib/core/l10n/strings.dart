...
class L10n extends ChangeNotifier {
  ...
  static const Map<String, String> _ro = {
    ...
    'dashboard.uclujResults': 'U CLUJ · REZULTAT',
    'dashboard.uclujThisWeek': 'U CLUJ · ACEASTĂ RUNDĂ',
    ...
    'dashboard.knockoutRound': 'Play-off / Play-out · Etapa {n}',
    'dashboard.playoff': 'PLAY-OFF',
    'dashboard.playout': 'PLAY-OUT',
    ...
    'standings.groupNote': 'Clasament din sezonul regulat. Punctele se înjumătățesc la startul play-off-ului.',
  ...
  static const Map<String, String> _en = {
    ...
    'dashboard.uclujResults': 'U CLUJ · RESULT',
    'dashboard.uclujThisWeek': 'U CLUJ · THIS ROUND',
    ...
    'dashboard.knockoutRound': 'Play-off / Play-out · Round {n}',
    'dashboard.playoff': 'PLAY-OFF',
    'dashboard.playout': 'PLAY-OUT',
    ...
    'standings.groupNote': 'Regular-season standings. Points halve when the play-off starts.',
